...
TEST(ShocDriver, HostDiffusionTransportModeHelperRejectsMoisture)
{
    EXPECT_TRUE(shoc_transport_mode_supports_moisture(
        ShocTransportMode::Tendencies, MoistureType::Morrison));
    EXPECT_TRUE(shoc_transport_mode_supports_moisture(
        ShocTransportMode::HostDiffusion, MoistureType::None));
    EXPECT_FALSE(shoc_transport_mode_supports_moisture(
        ShocTransportMode::HostDiffusion, MoistureType::Morrison));
}
