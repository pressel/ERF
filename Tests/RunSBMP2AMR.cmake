...
if(_variable_density_case)
    ...
    string(REGEX MATCHALL "SBM variable-density stage ratio level=[0-9]+ stage=[0-9]+ error=[0-9eE+.-]+ tolerance=[0-9eE+.-]+" _stage_ratio_matches "${simulation_log}")
    list(LENGTH _stage_ratio_matches _stage_ratio_count)
    if(_stage_ratio_count LESS 3)
        message(FATAL_ERROR "variable-density SBM run did not validate every compressible host stage")
    endif()
endif()
