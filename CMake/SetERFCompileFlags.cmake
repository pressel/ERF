...
function(erf_mark_cpp_sources_as_cuda target)
  if(NOT ERF_ENABLE_CUDA)
    return()
  endif()

  get_target_property(_erf_sources ${target} SOURCES)
  if(NOT _erf_sources)
    return()
  endif()

  foreach(_src IN LISTS _erf_sources)
...
function(erf_finalize_target target)
  set_erf_compile_flags(${target})
  erf_mark_cpp_sources_as_cuda(${target})
endfunction()
